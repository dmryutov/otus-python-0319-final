# Contributing to Analytical Toolkit
...
## Report bugs using GitLab's [issues](https://github.com/dmryutov/otus-python-0319-final/issues)
...
* **JavaScript** - Airbnb ESLint rules with some modifications
* **CSS** - Standard StyleLint rules with Rational Order plugin
* **Python** - PEP8

You can try running `npm run lint:fix` and `npm run lint:style:fix` for style unification
